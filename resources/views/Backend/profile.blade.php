                    ...
                    <div class="card card-xxl-stretch">
                        ...
                        <div class="card-header">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder text-dark">Profile</span>
                            </h3>
                        </div>
                        <!--begin::Card header-->
                        ...
                        <div class="card-header border-0 pt-6">
                            <form class="form" autocomplete="off" method="post" action="{{ route("admin.profileupdate") }}">
                                @csrf
                                ...
                                <div class="row g-9 mb-7">
                                    ...
                                    <div class="col-md-2 fv-row">
                                        <button type="submit"
                                            class="btn filterbtn btn-primary fw-bold my-8">Update</button>
                                    </div>
                                    <!--end::Col-->
                                </div>
                            </form>
                                ...
                                <div class="row g-9 mb-7">
                                    ...
                                    <div class="col-md-10 fv-row">
                                        ...
                                        <input type="password" name="password"
                                            ...
                                            placeholder="Enter password" required minlength="8" maxlength="15"/>
                                        <!--end::Input-->
                                    </div>
                                    <div class="col-md-2 fv-row">
                                        <button type="submit"
